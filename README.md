...
Before you can utilize the toolkit, you should first ensure your development machine meets the [system requirements](https://developers.arcgis.com/qt/v200/reference/system-requirements/) and has the ArcGIS Maps SDK for Qt properly [installed and set up](https://developers.arcgis.com/qt/v200/install-and-set-up/). TIP: the toolkit requires the installation of the **Qt WebEngine** which can be found under **Select Components > Extensions** section of the Qt installer.
...
|          Tool         | [Qt Quick UI components](https://github.com/Esri/arcgis-maps-sdk-toolkit-qt/tree/lts.next/uitools/toolkitcpp) |            [Qt Widgets UI components](https://github.com/Esri/arcgis-maps-sdk-toolkit-qt/tree/lts.next/uitools/toolkitwidgets)            |
|:---------------------:|:--------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------:|
