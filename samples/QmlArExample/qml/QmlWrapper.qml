...
QtObject {
    ...
    property var tmcc: TransformationMatrixCameraController {
    }
                                              ...
                                              translationX, translationY, translationZ)
    {
        var matrix = TransformationMatrix.createWithQuaternionAndTranslation(
                    ...
                    translationX, translationY, translationZ);
        tmcc.transformationMatrix = matrix;
    }
    ...
    // todo
    function setLocation(latitude, longitude, altitude)
    {
        console.log("\n====>>>>", latitude, longitude, altitude, tmcc);
