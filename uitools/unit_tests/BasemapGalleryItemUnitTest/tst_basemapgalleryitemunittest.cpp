...
BasemapGalleryItemUnitTest::BasemapGalleryItemUnitTest() = default;
...
void BasemapGalleryItemUnitTest::initTestCase()
{
  ...
  m_basemapLightGray = new Basemap(BasemapStyle::ArcGISLightGray, this);
  m_map = new Map(m_basemapLightGray, this);
...
{
  BasemapGalleryItem item(m_basemapLightGray);
  QCOMPARE(item.basemap(), m_basemapLightGray);
  QCOMPARE(item.name(), "ArcGIS Light Gray");
  ...
  QCOMPARE(item.thumbnail(), icon.pixmap(200, 133).toImage());
}
...
void BasemapGalleryItemUnitTest::ctor_Overrides()
{
  ...
  BasemapGalleryItem item(m_basemapLightGray, thumbnail, tooltip);
  QCOMPARE(item.basemap(), m_basemapLightGray);
