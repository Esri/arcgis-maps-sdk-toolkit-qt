...
The [NorthArrow - Qt Widgets UI/Class](https://developers.arcgis.com/qt/v200/toolkit/api-reference/esri-arcgisruntime-toolkit-northarrow.html) displays a compass overlaid on the GeoView, with the compass heading matching the current rotation of the MapView, or Camera heading of the SceneView. Double clicking on the NorthArrow triggers the heading of the connected GeoView to be oriented to 0.
