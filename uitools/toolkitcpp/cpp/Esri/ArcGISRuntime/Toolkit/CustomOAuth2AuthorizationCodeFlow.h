...
namespace Esri::ArcGISRuntime { class OAuthUserLoginPrompt; }
...
class CustomOAuth2AuthorizationCodeFlow : public QAbstractOAuth2
{
  Q_OBJECT
public:
  CustomOAuth2AuthorizationCodeFlow(const QUrl& m_authorizeUrl, QObject* parent);
  virtual ~CustomOAuth2AuthorizationCodeFlow();
...
private:
  ...
  OAuthUserLoginPrompt* m_prompt = nullptr;
