...
QtObject {
    ...
    /*!
      ...
      Each ListElement has a single property `variantObject`, which maps to a BasemapGalleryItem.
     */
    ...
    function append(basemap, thumbnailUrl, tooltip) {
        ...
        internal.gallery.append(
                    { "variantObject" : internal.galleryItem.createObject(
                                        this,
                                        {
                                            basemap: basemap,
    ...
    function basemapIndex(basemap) {
        ...
        for (let i = 0; i < gallery.count; i++) {
            let b = gallery.get(i).variantObject;
