...
- In the `CMakeLists.txt` file of your new application, you need to make two changes:
  - Uncomment the `include` line below, and replace `path/to/toolkitcpp.cmake` with the path to your `toolkitcpp.cmake` file.
...
- choose settings to match the platform etc. you are building for
- In the `CMakeLists.txt` file of your new application, you need to make two changes:
  - Uncomment the `include` line below, and replace `path/to/toolkitwidgets.cmake` with the path to your `toolkitwidgets.cmake` file.
