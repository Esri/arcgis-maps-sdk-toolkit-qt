...
ARCGIS_TOOLKIT_PATH = $$PWD/../../..

include($$ARCGIS_TOOLKIT_PATH/augmentedreality/ArApi/ArApi.pri) {
    error(Fails to open $$ARCGIS_TOOLKIT_PATH/augmentedreality/ArApi/ArApi.pri)
}
