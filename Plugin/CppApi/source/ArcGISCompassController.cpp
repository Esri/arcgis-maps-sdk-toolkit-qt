...
/*!
   ...
   \brief Whether the compass should be hidden when its heading is \c 0.0 (north).
 */
...
/*!
   \brief Returns the compass heading in degrees.
 */
...
/*!
   \brief Returns whether the compass should be visible if heading is \c 0.0 (north).
 */
